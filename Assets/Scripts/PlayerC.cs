...
public class PlayerC : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (animator != null) // Animator bileþeni varsa çalýþtýr
        {
    ...
    void MovePlayer()
    {
        float moveHorizontal = Input.GetAxis("Horizontal"); // Ok tuþlarý
        float moveVertical = Input.GetAxis("Vertical");     // Ok tuþlarý
