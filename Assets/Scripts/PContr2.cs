...
public class PContr2 : MonoBehaviour
{
    ...
    void MovePlayer()
    {
        ...
        isRunning = isWalking && Input.GetKey(KeyCode.RightShift);  // Shift tuþu ile koþma
    ...
    void Jump()
    {
        ...
        if (isGrounded && Input.GetKeyDown(KeyCode.RightControl))  // Zýplama için LeftControl tuþu
        {
